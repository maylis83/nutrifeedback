...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'app_nutritionist', (
            ...
            ('headshot', self.gf('django.db.models.fields.files.ImageField')(default='/nutritionist_headshots/none.jpg', max_length=100)),
            ('consultation_price', self.gf('django.db.models.fields.IntegerField')()),
        ))
        ...
        db.create_table(u'app_credential', (
            ...
            ('nutritionist', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='nutritionist_credential', null=True, to=orm['app.Nutritionist'])),
        ))
        ...
        # Adding model 'HealthSurvey'
        db.create_table(u'app_healthsurvey', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now)),
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ...
            ('exercise_freq', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('health_goals', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('dietary_restrictions', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('anything_else', self.gf('django.db.models.fields.CharField')(max_length=4096, null=True, blank=True)),
        ))
        db.send_create_signal(u'app', ['HealthSurvey'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'HealthSurvey'
        db.delete_table(u'app_healthsurvey')
