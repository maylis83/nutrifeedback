...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Nutritionist.headshot'
        db.add_column(u'app_nutritionist', 'headshot',
                      self.gf('django.db.models.fields.files.ImageField')(default='media/nutritionist_headshots/none.jpg', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Nutritionist.headshot'
        db.delete_column(u'app_nutritionist', 'headshot')
    ...
    models = {
        ...
        u'app.nutritionist': {
            ...
            'headshot': ('django.db.models.fields.files.ImageField', [], {'default': "'media/nutritionist_headshots/none.jpg'", 'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
