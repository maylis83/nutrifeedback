...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Nutritionist.consultation_price'
        db.add_column(u'app_nutritionist', 'consultation_price',
                      self.gf('django.db.models.fields.IntegerField')(default=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Nutritionist.consultation_price'
        db.delete_column(u'app_nutritionist', 'consultation_price')
