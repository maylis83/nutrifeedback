...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Consultation.consultation'
        db.delete_column(u'app_consultation', 'consultation')

        # Adding field 'Consultation.date'
        db.add_column(u'app_consultation', 'date',
                      self.gf('django.db.models.fields.DateField')(default=timezone.now()),
                      keep_default=False)

        # Adding field 'Consultation.time'
        db.add_column(u'app_consultation', 'time',
                      self.gf('django.db.models.fields.CharField')(default='early', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Consultation.consultation'
        db.add_column(u'app_consultation', 'consultation',
                      self.gf('django.db.models.fields.DateTimeField')(default=timezone.now()),
                      keep_default=False)

        # Deleting field 'Consultation.date'
        db.delete_column(u'app_consultation', 'date')

        # Deleting field 'Consultation.time'
        db.delete_column(u'app_consultation', 'time')
