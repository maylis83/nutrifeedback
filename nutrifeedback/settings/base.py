...
SECRET_KEY = "*frxv_^&z@_5pdmt03rrsaoj6_*5yg7qiv9^!ka+6j!%2w+f$$"
...
ROOT_URLCONF = 'nutrifeedback.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'nutrifeedback.wsgi.application'
...
DEFAULT_FROM_EMAIL = "hello@nutrifeedback.com"
SERVER_EMAIL = "error@nutrifeedback.com"
from nutrifeedback.settings.app import *
...
GRAPPELLI_ADMIN_TITLE = 'nutrifeedback'
